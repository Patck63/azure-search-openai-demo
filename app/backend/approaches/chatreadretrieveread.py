...
{injected_prompt}
"""
    follow_up_questions_prompt_content = """Generate three very brief follow-up questions that the user would likely ask next about cancers. 
    Use double angle brackets to reference the questions, e.g. <<Are there exclusions for prescriptions?>>.
    Try not to repeat questions that have already been asked.
    Only generate questions and do not generate any text before or after the questions, such as 'Next Questions'"""

    query_prompt_template = """Below is a history of the conversation so far, and a new question asked by the user that needs to be answered by searching in a knowledge base about cancers and related things.
...
"""
    query_prompt_few_shots = [
        {'role': USER, 'content': '大腸癌有什麼症狀？'},
        {'role': ASSISTANT, 'content': '大腸癌 症狀'},
        {'role': USER, 'content': '電療有什麼副作用？'},
        {'role': ASSISTANT, 'content': '電療 副作用'}
    ]
